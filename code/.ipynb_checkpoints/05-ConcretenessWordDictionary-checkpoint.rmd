...
```{r}
df <- read.csv('../data/Concrete_WordData_16032021.csv')
```
...
```{r}
concrete.onlyword <- lm(Concrete ~ Concrete.HighCount, df.train)
summary(concrete.onlyword)
```
