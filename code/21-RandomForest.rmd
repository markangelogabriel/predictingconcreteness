...
df <- within(df, rm("Response.x", "Steps", "Effective", "Emotion", "invalid_response", "Age.r", "Concrete", "Concrete.Low", "Concrete.Medium", "Concrete.High"))
df <- na.omit(df)
...
```{r}
concrete.rf <- randomForest(Concrete.Level ~ ., data=df.train, ntree=100, importance=TRUE, mtry=2)
